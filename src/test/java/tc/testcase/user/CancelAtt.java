...
public class CancelAtt extends ZhaoyanjiConfig{
    //TODO 接口名字拼写错误
    @BeforeClass
    ...
    public void cancelAtt(String msg,String ent_id,String id,String user_account,String password,String version,String expMsg,int expCode) throws Exception {
        ...
        JSONObject res = HttpRequest.sendRequest_EntityOrParas(httpRequest, host, "user/CancleAtt");
