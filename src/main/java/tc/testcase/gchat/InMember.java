...
public class InMember extends ZhaoyanjiConfig{
    ...
    public void inMember(String msg,String ent_id,String user_account,String g_id,String password,String version,String exp_msg,int exp_code) throws Exception {
        ...
        JSONObject res = HttpRequest.sendRequest(httpRequest, host, "gchat/inMember");
